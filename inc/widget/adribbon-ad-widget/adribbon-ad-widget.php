...
class Adribbon_Ad_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'adribbon_ad_widget',
            'Ytc Ad Widget',
            array('description' => __('Displays Ad Sidebar Widget', 'ytc'))
        );
    }
    ...
    public function form($instance) {
        $instance = wp_parse_args((array) $instance, array(
            ...
            'image1' => 'http://placehold.it/180x120',
            'url1' => '#',
            'title1' => __('Click to view this advertising.', 'ytc'),
            'image2' => 'http://placehold.it/180x120',
            'url2' => '#',
    ...
    ?>
        ...
        <p>
        <label for="<?php echo $this->get_field_id( 'image1' ); ?>"><?php _e( 'Image Link 1 (110x110):', 'ytc' ); ?></label> 
        ...
        <p>
        <label for="<?php echo $this->get_field_id( 'image2' ); ?>"><?php _e( 'Image Link 2 (110x110)', 'ytc' ); ?></label> 
    ...
    public function widget($args, $instance) { 
        ...
        echo $before_widget;
            ...
            <div class="ad-widget">
                ...
                <?php if (!empty($image1)) : ?>
                    <a class="left" href="<?php echo $url1 != '' ? $url1 : '#'; ?>" 
                ...
                <?php if (!empty($image2)) : ?>
                    <a class="right" href="<?php echo $url2 != '' ? $url1 : '#'; ?>" 
